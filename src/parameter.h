...
static int pieceSquareTable[ALL_PIECE_TYPE][ALL_SQUARE] = {
        { // pawns
                MS(0, 0),     MS(0, 0),     MS(0, 0),     MS(0, 0),     MS(0, 0),     MS(0, 0),     MS(0, 0),     MS(0,
                                                                                                                     0),
                MS(-1, -17),  MS(-7, -17),  MS(-11, -17), MS(-35, -17), MS(-13, -17), MS(5, -17),   MS(3, -17),   MS(-5,
                                                                                                                     -17),
                MS(1, -11),   MS(1, -11),   MS(-6, -11), MS(-19, -11), MS(-6, -11), MS(-7, -11), MS(-4, -11), MS(10,
                                                                                                                 -11),
        ...
        { // knights
                MS(-99, -99), MS(-30, -99), MS(-66, -94), MS(-64, -88), MS(-29, -88), MS(-19, -94), MS(-61,
                                                                                                       -99),      MS(-81,
                                                                                                                     -99),
                MS(-56, -81), MS(-31, -62), MS(-28, -49), MS(-1, -43),  MS(-7, -43),  MS(-20, -49), MS(-42,
                                                                                                       -62),      MS(-11,
                                                                                                                     -81),
                MS(-38, -46), MS(-16, -27), MS(0, -15),  MS(14, -9),   MS(8, -9),   MS(3, -15),  MS(3, -27),  MS(-42,
                                                                                                                 -46),
        ...
        { // bishops
                MS(-7, -27),  MS(12, -21),  MS(-8, -17),  MS(-37, -15), MS(-31, -15), MS(-8, -17),  MS(-45,
                                                                                                       -21),      MS(-67,
                                                                                                                     -27),
                MS(15, -10),  MS(5, -4),    MS(13, 0),    MS(-10, 2),   MS(1, 2),     MS(2, 0),     MS(0, -4),    MS(15,
                                                                                                                     -10),
        ...
        { // rooks
                MS(-2, -32),  MS(-1, -31),  MS(3, -30),   MS(1, -29),   MS(2, -29),   MS(1, -30),   MS(4, -31),   MS(-8,
                                                                                                                     -32),
                MS(-26, -27), MS(-6, -25),  MS(2, -24),   MS(-2, -24),  MS(2, -24),   MS(-10, -24), MS(-1,
                                                                                                       -25),      MS(-29,
                                                                                                                     -27),
                MS(-16, -15), MS(0, -13),   MS(3, -12),  MS(-3, -12),  MS(8, -12),  MS(-1, -12), MS(12, -13), MS(3,
                                                                                                                 -15),
        ...
        { //queen
                MS(1, -61),   MS(-10, -55), MS(-11, -52), MS(3, -50),   MS(-15, -50), MS(-51, -52), MS(-83,
                                                                                                       -55),      MS(-13,
                                                                                                                     -61),
                MS(-7, -31),  MS(3, -26),   MS(2, -22),   MS(5, -21),   MS(-1, -21),  MS(-10, -22), MS(-7, -26),  MS(-2,
                                                                                                                     -31),
                MS(-11, -8),  MS(0, -3),    MS(12, 1),   MS(2, 3),     MS(8, 3),    MS(11, 1),   MS(7, -3),   MS(-6,
                                                                                                                 -8),
        ...
        {    //king
                MS(0, -34),   MS(0, -30),   MS(0, -28),   MS(-9, -27),  MS(0, -27),   MS(-9, -28),  MS(25, -30),  MS(0,
                                                                                                                     -34),
                MS(-9, -17),  MS(-9, -13),  MS(-9, -11),  MS(-9, -10),  MS(-9, -10),  MS(-9, -11),  MS(-9, -13),  MS(-9,
                                                                                                                     -17),
                MS(-9, -2),   MS(-9, 2),    MS(-9, 4),   MS(-9, 5),    MS(-9, 5),   MS(-9, 4),   MS(-9, 2),   MS(-9,
                                                                                                                 -2),
...
static int bishopMobility[16] = {
        -7 * MS(+6, +4), -4 * MS(+6, +4), -2 * MS(+6, +4), +0 * MS(+6, +4), +1 * MS(+6, +4), +2 * MS(+6, +4),
        +3 * MS(+6, +4), +4 * MS(+6, +4),
        +5 * MS(+6, +4), +6 * MS(+6, +4), +7 * MS(+6, +4), +8 * MS(+6, +4), +9 * MS(+6, +4), +10 * MS(+6, +4),
        +10 * MS(+6, +4), +10 * MS(+6, +4)
};

static int rookMobility[16] = {
        -8 * MS(+5, +3), -6 * MS(+5, +3), -3 * MS(+5, +3), -1 * MS(+5, +3), +1 * MS(+5, +3), +2 * MS(+5, +3),
        +3 * MS(+5, +3), +4 * MS(+5, +3),
        +5 * MS(+5, +3), +6 * MS(+5, +3), +7 * MS(+5, +3), +8 * MS(+5, +3), +9 * MS(+5, +3), +10 * MS(+5, +3),
        +11 * MS(+5, +3), +12 * MS(+5, +3)
};

static int knightKingBonus[8] = {
        6 * MS(+2, +4), 6 * MS(+2, +4), 6 * MS(+2, +4), 4 * MS(+2, +4), 3 * MS(+2, +4), 2 * MS(+2, +4), 1 * MS(+2, +4),
        0 * MS(+2, +4)
};

static int bishopKingBonus[8] = {
        7 * MS(+2, +4), 6 * MS(+2, +4), 5 * MS(+2, +4), 4 * MS(+2, +4), 3 * MS(+2, +4), 2 * MS(+2, +4), 1 * MS(+2, +4),
        0 * MS(+2, +4)
};

static int rookKingBonus[8] = {
        7 * MS(+4, +6), 6 * MS(+4, +6), 5 * MS(+4, +6), 4 * MS(+4, +6), 3 * MS(+4, +6), 2 * MS(+4, +6), 1 * MS(+4, +6),
        0 * MS(+4, +6)
};

static int queenKingBonus[8] = {
        7 * MS(+5, +7), 6 * MS(+5, +7), 5 * MS(+5, +7), 4 * MS(+5, +7), 3 * MS(+5, +7), 2 * MS(+5, +7), 1 * MS(+5, +7),
        0 * MS(+5, +7)
};
...
static int spaceBonus[18] = {
        MS(+0, +0), MS(+0, +0), MS(+5, +5), MS(+7, +7), MS(+9, +9), MS(+15, +13), MS(+20, +17), MS(+25, +23),
        MS(+30, +27),
        MS(+35, +33), MS(+45, +45), MS(+50, +50), MS(+60, +60), MS(+70, +70), MS(+80, +80), MS(+90, +90),
...
inline void readParameters(std::string fileName) {
    ...
    if (file.is_open()) {
        ...
        updateArray(high, low, &kingZoneAttackWeight[PAWN][0], str, "PAWN_ATTACK_WEIGHT_MIDDLEGAME",
                    "PAWN_ATTACK_WEIGHT_ENDGAME", 10);
        updateArray(high, low, &kingZoneAttackWeight[KNIGHT][0], str, "KNIGHT_ATTACK_WEIGHT_MIDDLEGAME",
                    "KNIGHT_ATTACK_WEIGHT_ENDGAME", 10);
        updateArray(high, low, &kingZoneAttackWeight[BISHOP][0], str, "BISHOP_ATTACK_WEIGHT_MIDDLEGAME",
                    "BISHOP_ATTACK_WEIGHT_ENDGAME", 10);
        updateArray(high, low, &kingZoneAttackWeight[ROOK][0], str, "ROOK_ATTACK_WEIGHT_MIDDLEGAME",
                    "ROOK_ATTACK_WEIGHT_ENDGAME", 10);
        updateArray(high, low, &kingZoneAttackWeight[QUEEN][0], str, "QUEEN_ATTACK_WEIGHT_MIDDLEGAME",
                    "QUEEN_ATTACK_WEIGHT_ENDGAME", 10);

        //update passed pawn terms
        updateArray(high, low, &connectedPasserBonus[WHITE][0], str, "CONNECTED_PASSER_BONUS_MIDDLEGAME",
                    "CONNECTED_PASSER_BONUS_ENDGAME", ALL_RANK);
        updateArray(high, low, &connectedPasserBonus[BLACK][0], str, "CONNECTED_PASSER_BONUS_MIDDLEGAME",
                    "CONNECTED_PASSER_BONUS_ENDGAME", ALL_RANK, true);
        updateArray(high, low, &freePasserBonus[WHITE][0], str, "FREE_PASSER_BONUS_MIDDLEGAME",
                    "FREE_PASSER_BONUS_ENDGAME", ALL_RANK);
        updateArray(high, low, &freePasserBonus[BLACK][0], str, "FREE_PASSER_BONUS_MIDDLEGAME",
                    "FREE_PASSER_BONUS_ENDGAME", ALL_RANK, true);
        updateArray(high, low, &passedPawnBonus[WHITE][0], str, "PASSED_PAWN_BONUS_MIDDLEGAME",
                    "PASSED_PAWN_BONUS_ENDGAME", ALL_RANK);
        updateArray(high, low, &passedPawnBonus[BLACK][0], str, "PASSED_PAWN_BONUS_MIDDLEGAME",
                    "PASSED_PAWN_BONUS_ENDGAME", ALL_RANK, true);
        updateArray(high, low, &candidatePasserBonus[WHITE][0], str, "CANDIDATE_PASSER_BONUS_MIDDLEGAME",
                    "CANDIDATE_PASSER_BONUS_ENDGAME", ALL_RANK);
        updateArray(high, low, &candidatePasserBonus[BLACK][0], str, "CANDIDATE_PASSER_BONUS_MIDDLEGAME",
                    "CANDIDATE_PASSER_BONUS_ENDGAME", ALL_RANK, true);

        //pawn weight
        updateArray(high, low, &pawnWeight[WHITE][0], str, "PAWN_WEIGHT_MIDDLEGAME", "PAWN_WEIGHT_ENDGAME", ALL_FILE);
        updateArray(high, low, &pawnWeight[BLACK][0], str, "PAWN_WEIGHT_MIDDLEGAME", "PAWN_WEIGHT_ENDGAME", ALL_FILE,
                    true);
        ...
        //threat bonus
        updateArray(high, low, &threatBonus[PAWN][0], str, "PAWN_THREAT_BONUS_MIDDLEGAME", "PAWN_THREAT_BONUS_ENDGAME",
                    ALL_PIECE_TYPE);
        updateArray(high, low, &threatBonus[KNIGHT][0], str, "KNIGHT_THREAT_BONUS_MIDDLEGAME",
                    "KNIGHT_THREAT_BONUS_ENDGAME", ALL_PIECE_TYPE);
        updateArray(high, low, &threatBonus[BISHOP][0], str, "BISHOP_THREAT_BONUS_MIDDLEGAME",
                    "BISHOP_THREAT_BONUS_ENDGAME", ALL_PIECE_TYPE);
        updateArray(high, low, &threatBonus[ROOK][0], str, "ROOK_THREAT_BONUS_MIDDLEGAME", "ROOK_THREAT_BONUS_ENDGAME",
                    ALL_PIECE_TYPE);
        updateArray(high, low, &threatBonus[QUEEN][0], str, "QUEEN_THREAT_BONUS_MIDDLEGAME",
                    "QUEEN_THREAT_BONUS_ENDGAME", ALL_PIECE_TYPE);

        //knight outpost bonus
        updateArray(high, low, &knightOutpostBonus[WHITE][0], str, "KNIGHT_OUTPOST_BONUS_MIDDLEGAME",
                    "KNIGHT_OUTPOST_BONUS_ENDGAME", 64);
        updateArray(high, low, &knightOutpostBonus[BLACK][0], str, "KNIGHT_OUTPOST_BONUS_MIDDLEGAME",
                    "KNIGHT_OUTPOST_BONUS_ENDGAME", 64, true);
