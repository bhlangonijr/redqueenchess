...
#define KM(POS) VI(6,1,POS)
#define BM(POS) VI(4,1,POS)
#define RM(POS) VI(2,1,POS)

#define BK(POS) VI(1,3,POS)
#define RK(POS) VI(2,4,POS)
#define QK(POS) VI(3,5,POS)
...
const int knightMobilityBonus[maxGamePhase+1] = {KM(0),KM(1),KM(2),KM(3),KM(4),KM(5),KM(6),KM(7),KM(8),KM(9),KM(10),KM(11),KM(0),KM(12),KM(13),KM(14),
		KM(15),KM(16),KM(17),KM(18),KM(19),KM(20),KM(21),KM(22),KM(23),KM(24),KM(25),KM(26),KM(27),KM(28),KM(29),KM(30),KM(31)};
const int bishopMobilityBonus[maxGamePhase+1] = {BM(0),BM(1),BM(2),BM(3),BM(4),BM(5),BM(6),BM(7),BM(8),BM(9),BM(10),BM(11),BM(0),BM(12),BM(13),BM(14),
		BM(15),BM(16),BM(17),BM(18),BM(19),BM(20),BM(21),BM(22),BM(23),BM(24),BM(25),BM(26),BM(27),BM(28),BM(29),BM(30),BM(31)};
const int rookMobilityBonus[maxGamePhase+1] = {RM(0),RM(1),RM(2),RM(3),RM(4),RM(5),RM(6),RM(7),RM(8),RM(9),RM(10),RM(11),RM(0),RM(12),RM(13),RM(14),
		RM(15),RM(16),RM(17),RM(18),RM(19),RM(20),RM(21),RM(22),RM(23),RM(24),RM(25),RM(26),RM(27),RM(28),RM(29),RM(30),RM(31)};

const int bishopKingBonus[maxGamePhase+1] = {BK(0),BK(1),BK(2),BK(3),BK(4),BK(5),BK(6),BK(7),BK(8),BK(9),BK(10),BK(11),BK(0),BK(12),BK(13),BK(14),
		BK(15),BK(16),BK(17),BK(18),BK(19),BK(20),BK(21),BK(22),BK(23),BK(24),BK(25),BK(26),BK(27),BK(28),BK(29),BK(30),BK(31)};
const int rookKingBonus[maxGamePhase+1] =   {RK(0),RK(1),RK(2),RK(3),RK(4),RK(5),RK(6),RK(7),RK(8),RK(9),RK(10),RK(11),RK(0),RK(12),RK(13),RK(14),
		RK(15),RK(16),RK(17),RK(18),RK(19),RK(20),RK(21),RK(22),RK(23),RK(24),RK(25),RK(26),RK(27),RK(28),RK(29),RK(30),RK(31)};
const int queenKingBonus[maxGamePhase+1] =  {QK(0),QK(1),QK(2),QK(3),QK(4),QK(5),QK(6),QK(7),QK(8),QK(9),QK(10),QK(11),QK(0),QK(12),QK(13),QK(14),
		QK(15),QK(16),QK(17),QK(18),QK(19),QK(20),QK(21),QK(22),QK(23),QK(24),QK(25),QK(26),QK(27),QK(28),QK(29),QK(30),QK(31)};

const int minorKingZoneAttackBonus[maxGamePhase+1] = {ZI(0),ZI(1),ZI(2),ZI(3),ZI(4),ZI(5),ZI(6),ZI(7),ZI(8),ZI(9),ZI(10),ZI(11),ZI(0),ZI(12),ZI(13),ZI(14),
		ZI(15),ZI(16),ZI(17),ZI(18),ZI(19),ZI(20),ZI(21),ZI(22),ZI(23),ZI(24),ZI(25),ZI(26),ZI(27),ZI(28),ZI(29),ZI(30),ZI(31)};
const int majorKingZoneAttackBonus[maxGamePhase+1] = {ZA(0),ZA(1),ZA(2),ZA(3),ZA(4),ZA(5),ZA(6),ZA(7),ZA(8),ZA(9),ZA(10),ZA(11),ZA(0),ZA(12),ZA(13),ZA(14),
...
const int endGamePieceSquareTable[ALL_PIECE_TYPE_BY_COLOR][ALL_SQUARE]={
		...
		{ // white pawn
				000,000,000,000,000,000,000,000,
				-15,-05,010,-20,-20,010,-05,-15,
				-15,-05,-10,000,000,-10,-05,-15,
				-15,-05,-10,020,020,-10,-05,-15,
				-15,-05,000,005,005,000,-05,-15,
				-15,-05,010,010,010,010,-05,-15,
				-15,-05,050,050,050,050,-05,-15,
				000,000,000,000,000,000,000,000,
		},
		{//white knight
				-50,-40,-30,-30,-30,-30,-40,-50,
		...
		{//white queen
				...
				000,000,005,015,015,005,000,-05,
