...
public:
	...
	enum MoveType {
		UNKNOW=0, TT_MOVE=1, CAPTURE=2, NON_CAPTURE=4, PROMOTION=8,
		CASTLE=16, KILLER1=32, KILLER2=64, GOOD_MOVE=128, BAD_MOVE=256,
		GOOD_CAPTURE=GOOD_MOVE|CAPTURE, BAD_CAPTURE=BAD_MOVE|CAPTURE,
		PROMO_CAPTURE=PROMOTION|CAPTURE, PROMO_NONCAPTURE=PROMOTION|NON_CAPTURE
	};
