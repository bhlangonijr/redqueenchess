...
// castle squares
    const Bitboard castleSquare[ALL_PIECE_COLOR][ALL_CASTLE_RIGHT] = {
            /*WHITE*/{EMPTY_BB, Sq2Bb(F1) | Sq2Bb(G1), Sq2Bb(D1) | Sq2Bb(C1) | Sq2Bb(B1),
                                                                                          Sq2Bb(F1) | Sq2Bb(G1) |
Sq2Bb(D1) | Sq2Bb(C1) | Sq2Bb(B1)},
            /*BLACK*/
                     {EMPTY_BB, Sq2Bb(F8) | Sq2Bb(G8), Sq2Bb(D8) | Sq2Bb(C8) | Sq2Bb(B8), Sq2Bb(F8) | Sq2Bb(G8) |
                                                                                          Sq2Bb(D8) | Sq2Bb(C8) |
                                                                                          Sq2Bb(B8)},
            /*NONE */
                     {EMPTY_BB, EMPTY_BB, EMPTY_BB,    EMPTY_BB}
    };
...
public:
    ...
    Bitboard getDCPieces(const Bitboard pseudoAttacks, const Bitboard attackingPieces,
                         const Bitboard attacks, const Bitboard discoveredCandidates, const Bitboard sidePieces,
                         const bool diagonalAttacks);
...
// generate pawn captures
inline void
Board::generatePawnCaptures(MoveIterator &moves, const PieceColor side, const Bitboard mask, Bitboard pieces) {
...
// generate knight moves
inline void
Board::generateKnightMoves(MoveIterator &moves, const PieceColor side, const Bitboard mask, Bitboard pieces) {
...
// generate bishop moves
inline void
Board::generateBishopMoves(MoveIterator &moves, const PieceColor side, const Bitboard mask, Bitboard pieces) {
...
// generate queen moves
inline void
Board::generateQueenMoves(MoveIterator &moves, const PieceColor side, const Bitboard mask, Bitboard pieces) {
